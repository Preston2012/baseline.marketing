  ...
  return (
    <>
      ...
      <section className="section" aria-label="What Baseline measures">
        ...
        <span className="redacted-label" style={{ marginBottom: 12, display: "block" }}>Classified until launch</span>
        ...
        <span className="redacted-label" style={{ marginBottom: 24, display: "block" }}>Classified until launch</span>
