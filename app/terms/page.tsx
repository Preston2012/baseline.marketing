  ...
  return (
    ...
    >
      ...
      <ul className="p">
        ...
        <li>
          <strong>Pro ($9.99/month or $89.99/year):</strong> Ad-free with access to The Lens Lab&trade;, Framing
          Radar&trade;, Historical Trends, Vote Tracking, and Annotations (100 limit). Launch price: $7.99/mo for
          the first 60 days, then $9.99/mo.
        </li>
        <li>
          <strong>Pro+ ($29.99/month or $249.99/year):</strong> All Pro features with higher limits and Annotations
          (500 limit).
        </li>
        <li>
          <strong>B2B ($499.99/month or $3,999.99/year):</strong> All Pro+ features with maximum throughput,
      ...
      <p className="p">
        &ldquo;Baseline,&rdquo; &ldquo;The Receipt,&rdquo; &ldquo;Framing Radar,&rdquo; &ldquo;The Lens Lab,&rdquo;
