...
export const metadata: Metadata = {
  title: "Methodology",
  description:
    "Instrument-grade methodology for Baseline: independent processing, side-by-side outputs, separate consensus, framing measurement, append-only records, and sources/context handling.",
