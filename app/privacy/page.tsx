  ...
  return (
    ...
    >
      ...
      <ul className="p">
        ...
        <li>
          <strong>User Preferences:</strong> App settings such as theme preference and notification preferences,
      ...
      <p className="p">
        ...
        and Search surfaces. Advertisements are never displayed on analysis surfaces (Statement Detail, Lens Lab,
        Framing Radar, Trends, or Receipt screens). Paid subscribers (Pro, Pro+, B2B) do not see any
        advertisements.
      </p>
      <p className="p">
