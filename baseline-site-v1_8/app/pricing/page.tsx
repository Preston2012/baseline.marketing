...
export const metadata: Metadata = {
  title: "Pricing",
  description: "Speech measurement at every level. Three parallel AI systems. Semantic similarity, framing metrics, and provision drift. Core free. Pro $7.99/mo. Pro+ $24.99/mo.",
